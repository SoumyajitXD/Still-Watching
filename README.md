...
For the complete repository-maintained list, read [`latest-modlist.md`](./latest-modlist.md).

| Category | Examples |
| --- | --- |
| **Horror** | The Anomaly, The Man From The Fog, From The Fog, The Mimicer, Apollyon, Siren Head, GoatMan, Cave Dweller Reimagined, The Knocker |
| **Atmosphere and sound** | AmbientSounds 6, Presence Footsteps, Sound Physics Remastered, EnhancedVisuals, Cave Dweller Sound Overhaul |
| **World and structures** | Biomes O' Plenty, Valhelsia Structures, Dungeons Enhanced, Towns and Towers, Explorify |
| **Multiplayer and utility** | Simple Voice Chat, FTB Teams, FTB Quests, JourneyMap, Corpse, JEI, Traveler's Backpack |
| **Visuals and performance** | Embeddium, Chloride, Oculus, Entity Model Features, Entity Texture Features, Euphoria Patches |
| **Shaders and resources** | Complementary Unbound, Complementary Reimagined, Hysteria Shaders, Insanity Shader, Spooklementary, Fresh Animations |
...
2. Open the [Still Watching CurseForge page](https://www.curseforge.com/minecraft/modpacks/still-watching).
3. Confirm the project is by **Soumyajit**.
4. Install the latest release.
5. Allocate **`5 GB` minimum RAM**; use **`6–8 GB`** if your system allows it.
