...
<img src="./still-watching-logo.jpg" alt="Still Watching modpack logo" width="240" />
...
| **Atmosphere & sound** | AmbientSounds, Presence Footsteps, Sound Physics Remastered, EnhancedVisuals |
...
Multiplayer is supported when every player and the server use matching pack versions, configs, and files.

Keep it boring:

- Same Still Watching version on server and clients.
...
<a href="https://url-shortener.curseforge.com/AZDOs" rel="nofollow">
  <img src="https://media.forgecdn.net/attachments/description/1420406/description_0434b1be-41ee-4fa8-a2f5-177b2fe87c95.png" alt="Make a Still Watching server and get 25 percent off with BisectHosting" width="850" />
</a>
...
| **Low FPS** | Lower render distance, reduce shaders/visual settings, and check RAM allocation. |
| **Server/client mismatch** | Match the exact pack version, Forge version, configs, and files on server and clients. |
