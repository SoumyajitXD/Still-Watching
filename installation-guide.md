...
This repository is for documentation, issue tracking, source-side material, and licensing clarity. Player downloads should come from CurseForge.
...
| Problem | Start here |
| --- | --- |
| Won't launch | Check RAM, Forge version, and profile repair |
...
| No atmosphere/audio | Check headphones and sound sliders |
...
These are optional polish upgrades for later:

- Add screenshots for CurseForge search, profile options, RAM allocation, and My Modpacks.
- Add `.github/ISSUE_TEMPLATE/bug_report.yml`.
- Add `.github/ISSUE_TEMPLATE/crash_report.yml`.
- Add `.github/ISSUE_TEMPLATE/server_issue.yml`.
- Add release-specific notes when major pack updates change installation or server behavior.

Screenshots and issue templates are not decorative glitter. They reduce support chaos.
