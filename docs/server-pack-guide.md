...
Still Watching servers should stay predictable in the places where predictability saves worlds. This guide is for the current documented release, **Still Watching V1.1.1**, targeting Minecraft `1.20.1` on Forge with Java `17` when required.
